#!/bin/bash
#!/bin/sh
#Code:Anar Ismayilzada
#Azerbaycan Hacker Qrupu
#İnstagram : @xaker_xidmeti.beta
#instagram : @by_praqramist
clear
case $1 in
...
echo -e '\033[31;40;1m 
	...
	──────────────█████████████─────────────
	   ...
	   \e[35m☾★ ☾★ ☾★ ☾★ AnarIsmayilzada ☾★ ☾★ ☾★ ☾★	
	 \e[31m☾★ ☾★ ☾★ ☾★ Azerbaycan Hacker Qrupu DarkWeb ☾★ ☾★ ☾★ ☾★	
  \e[32m☾★ ☾★ ☾★ ☾★ İnstagram : @xaker_xidmeti.beta ☾★ ☾★ ☾★ ☾★	
'
echo -e '
...
if [[ $islem == 1 || $islem == 01 ]]; then
	...
	echo -e '\033[36;40;1m Daxil etdiyiniz nomreni duzgun qeyd edin....'	
	sleep 1
	clear 
	banner
fi
